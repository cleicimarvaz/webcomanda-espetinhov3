...
3. Executar o bootstrap administrativo apenas após revisar os dados de exemplo.
4. Executar `arq/testes-v3/001-validacao-schema-base.sql`.
5. Executar este pre-flight para conferir funções, views e triggers.
...
- as funções transacionais devem aparecer no resultado;
